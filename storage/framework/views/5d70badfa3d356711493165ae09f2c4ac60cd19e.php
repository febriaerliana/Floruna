        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-header-action">
                    <a href="<?php echo e(route('dashboard.admin.flora.create')); ?>" class="btn btn-primary">Tambah
                        Flora</a>
                </div>
            </div>
                        ...
                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo e(route('dashboard.admin.flora.edit',$product->id)); ?>"
                                       class="btn btn-primary btn-action mr-1" data-toggle="tooltip" title="Edit"><i
                                            class="fas fa-pencil-alt"></i></a>
                                    <a href="<?php echo e(route('dashboard.admin.flora.download',$product->id)); ?>" target="_blank"
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        $('.btn-delete-flora').click(function () {
            var id = $(this).data('id');
            $('#form-delete-flora').attr('action', '<?php echo e(route('dashboard.admin.flora.destroy')); ?>/' + id)
        })
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KULIAH\SEMESTER 7\PPL\florafauna\resources\views/modules/dashboard/flora/index.blade.php ENDPATH**/ ?>