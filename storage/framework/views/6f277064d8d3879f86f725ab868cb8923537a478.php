...
<?php $__env->startSection('title','Flora Tambah'); ?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form method="POST" action="<?php echo e(route('dashboard.admin.flora.store')); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KULIAH\SEMESTER 7\PPL\florafauna\resources\views/modules/dashboard/flora/create.blade.php ENDPATH**/ ?>