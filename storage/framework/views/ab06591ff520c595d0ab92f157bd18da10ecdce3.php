                    ...
                    <div class="card-body">
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <a href="<?php echo e(route('dashboard.user.flora.show',$product->id)); ?>">Detail</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KULIAH\SEMESTER 7\PPL\florafauna\resources\views/modules/dashboard/users/flora/index.blade.php ENDPATH**/ ?>