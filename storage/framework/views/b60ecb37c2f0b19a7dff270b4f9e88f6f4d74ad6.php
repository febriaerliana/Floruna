        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('dashboard.user.fauna.download',$product->id)); ?>"
                       target="_blank"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KULIAH\SEMESTER 7\PPL\florafauna\resources\views/modules/dashboard/users/fauna/show.blade.php ENDPATH**/ ?>